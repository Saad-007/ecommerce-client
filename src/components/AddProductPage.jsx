...
const categories = [
  ...
  { value: "laptops", label: "Laptops" }, // ✅ match Navbar path
  { value: "accessories", label: "Accessories" },
  { value: "furniture", label: "Furniture" }, // ✅ match subcategory
...
export default function AddProductPage() {
  ...
  const handleChange = (e) => {
    ...
    if (type === "checkbox") {
      ...
      Promise.all(validFiles.map(toBase64)).then((base64Images) => {
        setFormData((prev) => ({
          ...prev,
  ...
  const handleSubmit = async (e) => {
    ...
    const base64Images = await Promise.all(
      formData.images.map(async (img) => {
        if (typeof img === 'string') return img; // Already base64
      ...
      const newProduct = {
        id: uuidv4(),
        ...formData,
        image: base64Images[0], // or cover image
        images: base64Images, // array of all uploaded images
...
{/* Add this new checkbox for featured product */}
                ...
                <div>
                  <div>
                    ...
                    <div className="space-y-4">
                      <label className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                          ...
                          <p className="text-xs text-gray-500">
                            PNG, JPG (max. 5MB each, 3-4 images recommended)
                          </p>
                        </div>
                        <input
                          id="image-upload"
                      ...
                      {/* Image previews with max 4 images */}
                      ...
                      {imagePreviews.length > 4 && (
                        <p className="text-sm text-yellow-600">
                          Only the first 4 images will be displayed on the
                          product page
                        </p>
                      )}
                    </div>
